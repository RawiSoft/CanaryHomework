...
- (id)initWithDeviceID:(NSString *)deviceID andName:(NSString *)deviceName {
    ...
    if (self) {
        ...
        self.detailView = [[DetailView alloc] initWithDeviceID:deviceID];
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    [[self detailView] fetchReadings:^(BOOL completed, BOOL success, NSDictionary<NSString *,NSNumber *> * _Nonnull readingsMinMaxAvgDict) {
        NSLog(@"%@", readingsMinMaxAvgDict);
        [self updateLabelsFromDictionary:readingsMinMaxAvgDict ];
    }];
}
- (void)updateDeviceInfoLabels {
    self.deviceNameLabel.text = [NSString stringWithFormat:@"Name: %@",  self.deviceName];
    self.deviceIDLabel.text = [NSString stringWithFormat:@"ID: %@", self.deviceID];
}
- (void)updateLabelsFromDictionary: (NSDictionary<NSString *, NSNumber *> *) readingsMinMaxAvgDict {
    
    self.temperatureMinLabel.text = [NSString stringWithFormat:@"Min: %@", readingsMinMaxAvgDict[MIN_TEMPERATURE_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MIN_TEMPERATURE_KEY] stringValue]];
    
    self.temperatureMaxLabel.text = [NSString stringWithFormat:@"Max: %@", readingsMinMaxAvgDict[MAX_TEMPERATURE_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MAX_TEMPERATURE_KEY] stringValue]];
    self.temperatureAverageLabel.text = [NSString stringWithFormat:@"Average: %@", readingsMinMaxAvgDict[AVERAGE_TEMPERATURE_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[AVERAGE_TEMPERATURE_KEY] stringValue]];
    
    self.humidityMinLabel.text = [NSString stringWithFormat:@"Min: %@", readingsMinMaxAvgDict[MIN_HUMIDITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MIN_HUMIDITY_KEY] stringValue]];
    self.humidityMaxLabel.text = [NSString stringWithFormat:@"Max: %@", readingsMinMaxAvgDict[MAX_HUMIDITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MAX_HUMIDITY_KEY] stringValue]];
    self.humidityAverageLabel.text = [NSString stringWithFormat:@"Average: %@",  readingsMinMaxAvgDict[AVERAGE_HUMIDITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[AVERAGE_HUMIDITY_KEY] stringValue]];
    
    self.airQualityMinLabel.text = [NSString stringWithFormat:@"Min: %@",  readingsMinMaxAvgDict[MIN_AIR_QUALITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MIN_AIR_QUALITY_KEY] stringValue]];
    self.airQualityMaxLabel.text = [NSString stringWithFormat:@"Max: %@", readingsMinMaxAvgDict[MAX_AIR_QUALITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[MAX_AIR_QUALITY_KEY] stringValue]];
    self.airQualityAverageLabel.text = [NSString stringWithFormat:@"Average: %@",  readingsMinMaxAvgDict[AVERAGE_AIR_QUALITY_KEY] == nil ? @"N/A": [readingsMinMaxAvgDict[AVERAGE_AIR_QUALITY_KEY] stringValue]];
}
...
- (void)setupUI {
    ...
    self.deviceInfoTopConstraint = [self.deviceInfoStackView.topAnchor constraintEqualToAnchor:self.view.safeAreaLayoutGuide.topAnchor constant:K_PADDING];
    self.temperatureTopConstraint = [self.temperatureStackView.topAnchor constraintEqualToAnchor:self.deviceInfoStackView.bottomAnchor constant:K_PADDING];
    self.humidityTopConstraint = [self.humidityStackView.topAnchor constraintEqualToAnchor:self.temperatureStackView.bottomAnchor constant:K_PADDING];
    self.airQualityTopConstraint = [self.airQualityStackView.topAnchor constraintEqualToAnchor:self.humidityStackView.bottomAnchor constant:K_PADDING];
    
    [NSLayoutConstraint activateConstraints:@[
        
        self.deviceInfoTopConstraint,
        [self.deviceInfoStackView.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:K_PADDING],
        [self.deviceInfoStackView.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant: -K_PADDING],
        
        self.temperatureTopConstraint,
        [self.temperatureStackView.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:K_PADDING],
        [self.temperatureStackView.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant: -K_PADDING],
        
        self.humidityTopConstraint,
        [self.humidityStackView.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:K_PADDING],
        [self.humidityStackView.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant: -K_PADDING],
        
        self.airQualityTopConstraint,
        [self.airQualityStackView.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:K_PADDING],
        [self.airQualityStackView.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant: -K_PADDING],
       
    ]];
}

- (UIStackView *)buildStackViewWithTitleLabel:(UILabel *)titleLabel topLabel:(UILabel *)topLabel midLabel:(UILabel*)midLabel bottomLabel:(UILabel *)bottomLabel {
